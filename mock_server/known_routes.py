...
from .handlers.flights_search import post_flights_search, post_flights_search_with_cart, get_flights_search_with_cart
from .handlers.bookings import post_bookings
...
from .handlers.meals import delete_shopping_cart_meals, put_select_meals, put_update_meals
...
def _override_handler(path: str, methods: list[str]):
    ...
    if path == "/api/v1/orders/{orderId}/shoppingCarts/{shoppingCartId}/flights/search" and "GET" in methods:
        return get_flights_search_with_cart
...
# Step 5: choose option/solution inside flights search.
    ...
    # Step 9: meals/drinks selection.
    if path == "/api/v1/orders/{orderId}/shoppingCarts/{shoppingCartId}/airs/{airId}/meals" and "PUT" in methods:
        return put_select_meals
    if path == "/api/v1/orders/{orderId}/shoppingCarts/{shoppingCartId}/airs/{airId}/meals" and "DELETE" in methods:
        return delete_shopping_cart_meals
    if path == "/api/v1/orders/{orderId}/shoppingCarts/{shoppingCartId}/airs/{airId}/ancillaries/meals" and "PUT" in methods:
        return put_update_meals


    # Step 10: bookings creation.
    if path == "/api/v1/orders/{orderId}/shoppingCarts/{shoppingCartId}/bookings" and "POST" in methods:
